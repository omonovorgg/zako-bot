...
async def init_db():
    ...
    async with p.acquire() as c:
        ...
        frame_seed=[('⚡ Ice Frame','Muzdek energiya halqasi','ice',120,20),('☠️ Venom Frame','Zaharli yashil animatsiya','venom',250,21),('🔥 Inferno Frame','Olovli premium animatsiya','inferno',500,22),('👑 Royal Frame','Oltin qirollik animatsiyasi','royal',1000,23)]
